...
export const T: Dict = {
  appName: { en: "ActivePals AI", "zh-HK": "ActivePals AI", "zh-CN": "ActivePals AI" },
  tagline: {
    en: "AI Exercise Battles for Kids",
    "zh-HK": "小朋友 AI 運動對戰",
    "zh-CN": "小朋友 AI 运动对战",
  },
  pickChallenge: { en: "Pick a Challenge", "zh-HK": "選擇挑戰", "zh-CN": "选择挑战" },
  ...
  startChallenge: { en: "Start Challenge", "zh-HK": "開始挑戰", "zh-CN": "开始挑战" },
  searching: { en: "Searching for Pals…", "zh-HK": "正在尋找對手…", "zh-CN": "正在寻找对手…" },
