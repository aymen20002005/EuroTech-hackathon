...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "ActivePals AI Arena is a gamified sports app for kids to challenge each other in exercise battles." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "ActivePals AI Arena is a gamified sports app for kids to challenge each other in exercise battles." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Bungee&family=Fredoka:wght@400;500;600;700&family=Noto+Sans+HK:wght@500;700&family=Noto+Sans+SC:wght@500;700&display=swap",
      },
    ],
  }),
